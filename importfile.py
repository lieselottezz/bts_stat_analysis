...
def stat_54(csvfile, btsstat_54):
    """Create Dictionary to store data from BTS Stat 2554"""
    for i in csvfile['Mo Chit'][0:12]:
        btsstat_54.setdefault('Mo Chit', [])
        btsstat_54['Mo Chit'].append(i)

    for i in csvfile['Saphan Khwai'][0:12]:
        btsstat_54.setdefault('Saphan Khwai', [])
        btsstat_54['Saphan Khwai'].append(i)
        
    for i in csvfile['Ari'][0:12]:
        btsstat_54.setdefault('Ari', [])
        btsstat_54['Ari'].append(i)
        
    for i in csvfile['Sanam Pao'][0:12]:
        btsstat_54.setdefault('Sanam Pao', [])
        btsstat_54['Sanam Pao'].append(i)
        
    for i in csvfile['Victory Monument'][0:12]:
        btsstat_54.setdefault('Victory Monument', [])
        btsstat_54['Victory Monument'].append(i)

    for i in csvfile['Phaya Thai'][0:12]:
        btsstat_54.setdefault('Phaya Thai', [])
        btsstat_54['Phaya Thai'].append(i)

    for i in csvfile['Ratchathewi'][0:12]:
        btsstat_54.setdefault('Ratchathewi', [])
        btsstat_54['Ratchathewi'].append(i)

    for i in csvfile['Siam'][0:12]:
        btsstat_54.setdefault('Siam', [])
        btsstat_54['Siam'].append(i)

    for i in csvfile['Chit Lom'][0:12]:
        btsstat_54.setdefault('Chit Lom', [])
        btsstat_54['Chit Lom'].append(i)

    for i in csvfile['Phloen Chit'][0:12]:
        btsstat_54.setdefault('Phloen Chit', [])
        btsstat_54['Phloen Chit'].append(i)

    for i in csvfile['Nana'][0:12]:
        btsstat_54.setdefault('Nana', [])
        btsstat_54['Nana'].append(i)

    for i in csvfile['Asok'][0:12]:
        btsstat_54.setdefault('Asok', [])
        btsstat_54['Asok'].append(i)

    for i in csvfile['Phrom Phong'][0:12]:
        btsstat_54.setdefault('Phrom Phong', [])
        btsstat_54['Phrom Phong'].append(i)

    for i in csvfile['Thong Lo'][0:12]:
        btsstat_54.setdefault('Thong Lo', [])
        btsstat_54['Thong Lo'].append(i)

    for i in csvfile['Ekkamai'][0:12]:
        btsstat_54.setdefault('Ekkamai', [])
        btsstat_54['Ekkamai'].append(i
                                         )
    for i in csvfile['Phra Khanong'][0:12]:
        btsstat_54.setdefault('Phra Khanong', [])
        btsstat_54['Phra Khanong'].append(i)

    for i in csvfile['On Nut'][0:12]:
        btsstat_54.setdefault('On Nut', [])
        btsstat_54['On Nut'].append(i)

    for i in csvfile['Bang Chak'][0:12]:
        btsstat_54.setdefault('Bang Chak', [])
        btsstat_54['Bang Chak'].append(i)

    for i in csvfile['Punnawithi'][0:12]:
        btsstat_54.setdefault('Punnawithi', [])
        btsstat_54['Punnawithi'].append(i)

    for i in csvfile['Udom Suk'][0:12]:
        btsstat_54.setdefault('Udom Suk', [])
        btsstat_54['Udom Suk'].append(i)

    for i in csvfile['Bang Na'][0:12]:
        btsstat_54.setdefault('Bang Na', [])
        btsstat_54['Bang Na'].append(i)

    for i in csvfile['Bearing'][0:12]:
        btsstat_54.setdefault('Bearing', [])
        btsstat_54['Bearing'].append(i)

    for i in csvfile['Ratchadamri'][0:12]:
        btsstat_54.setdefault('Ratchadamri', [])
        btsstat_54['Ratchadamri'].append(i)

    for i in csvfile['Sala Daeng'][0:12]:
        btsstat_54.setdefault('Sala Daeng', [])
        btsstat_54['Sala Daeng'].append(i)

    for i in csvfile['Chong Nonsi'][0:12]:
        btsstat_54.setdefault('Chong Nonsi', [])
        btsstat_54['Chong Nonsi'].append(i)

    for i in csvfile['Surasak'][0:12]:
        btsstat_54.setdefault('Surasak', [])
        btsstat_54['Surasak'].append(i)

    for i in csvfile['Saphan Taksin'][0:12]:
        btsstat_54.setdefault('Saphan Taksin', [])
        btsstat_54['Saphan Taksin'].append(i)

    for i in csvfile['Krung Thon Buri'][0:12]:
        btsstat_54.setdefault('Krung Thon Buri', [])
        btsstat_54['Krung Thon Buri'].append(i)

    for i in csvfile['Wongwian Yai'][0:12]:
        btsstat_54.setdefault('Wongwian Yai', [])
        btsstat_54['Wongwian Yai'].append(i)

    for i in csvfile['Pho Nimit'][0:12]:
        btsstat_54.setdefault('Pho Nimit', [])
        btsstat_54['Pho Nimit'].append(i)

    for i in csvfile['Talat Phlu'][0:12]:
        btsstat_54.setdefault('Talat Phlu', [])
        btsstat_54['Talat Phlu'].append(i)

    for i in csvfile['Wutthakat'][0:12]:
        btsstat_54.setdefault('Wutthakat', [])
        btsstat_54['Wutthakat'].append(i)

    for i in csvfile['Bang Wa'][0:12]:
        btsstat_54.setdefault('Bang Wa', [])
        btsstat_54['Bang Wa'].append(i)\

    for i in csvfile['National Stadium'][0:12]:
        btsstat_54.setdefault('National Stadium', [])
        btsstat_54['National Stadium'].append(i)

    return btsstat_54

def stat_55(csvfile, btsstat_55):
...
def stat_56(csvfile, btsstat_56):
...
def stat_57(csvfile, btsstat_57):
